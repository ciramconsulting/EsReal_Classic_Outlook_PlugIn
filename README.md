...
Developed by Ciram Consulting BV
...
Microsoft Visual Studio Tools for Office Runtime (VSTO)
---
Installation
Option 1 — ClickOnce installer (recommended)
Right-click `trust_vsto.reg` and run as administrator (one-time setup)
Double-click `EsRealOutlookAddin.vsto` to install
Restart Outlook
Option 2 — Build from source
Clone this repository
Open `EsRealOutlookAddin.sln` in Visual Studio 2022
Restore NuGet packages
Build and publish via `Publish` in Visual Studio
---
Configuration
